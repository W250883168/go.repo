 ...
 */
app.controller('ktController', function ($scope, httpService, notificService, $location, settings, $window, $filter, $modal, TipService) {
    ...
    $scope.model = {
        title:"模式",
        default: {code: 0x00, name: "自动"},
        current: {code: 0x00, name: "自动"},
        list: [
            {code: 0x00, name: "自动"},
            {code: 0x01, name: "制冷"},
            {code: 0x02, name: "除湿"},
    ...
    //alert($scope.fnCmdCombind(0xAA,0xAA,0x08,0x08));
    //alert($scope.fnCmdCombind(0xcc,0xcc,0x08,0x08));
