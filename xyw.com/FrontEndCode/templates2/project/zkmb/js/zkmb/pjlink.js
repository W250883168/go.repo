 ...
 */
app.controller('pjlinkController',['$scope', 'httpService','$location','$window','$interval','$timeout','$modal','$filter','toaster', function ($scope, httpService,$location,$window,$interval,$timeout,$modal,$filter,toaster) {
    var timer;   //get query parameter
	...
	/*  -------------------- 分页、页码  -----------------------  */
	/*    分页页码        */
	//   pagedata： obj     post 的  分页数据
	//   maxpagenumber:number      分页显示页码数
	/*----------------
	//    分页对象添加页码
	//    return  obj  分页对象
	//    pagedata:obj  分页对象
